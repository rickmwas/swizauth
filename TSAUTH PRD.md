...
TSAUTH serves as the centralized source of truth for user identities, permissions, organizations, sessions, API access, and security policies.

------------------------------------------------------------------------

# 2. Vision {#vision}

Create a reusable authentication and identity platform that allows any TerraSept application or client application to implement enterprise-grade security without rebuilding authentication logic.
...
Controls entire TSAUTH ecosystem.
...
- 10+ Internal Products Using TSAUTH
...
TSAUTH becomes the central identity platform powering:
